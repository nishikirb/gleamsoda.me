...
type CardEyebrowProps<E extends React.ElementType> = {
  as?: E
  decorate?: boolean
}
...
type Props<E extends React.ElementType> = React.PropsWithChildren<
  CardEyebrowProps<E>
> &
  Omit<React.ComponentPropsWithoutRef<E>, keyof CardEyebrowProps<E>>

Card.Eyebrow = function CardEyebrow<E extends React.ElementType = 'p'>({
  as,
  decorate = false,
  className,
  children,
